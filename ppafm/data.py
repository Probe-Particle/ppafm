...
DATASET_URLS = {
    ...
    "FFPB_KPFM_hartree": "https://zenodo.org/records/10563098/files/KPFM_hartree.tar.gz?download=1",
}
...
def download_dataset(name: str, target_dir: PathLike):
    ...
    The following datasets are available:
        ...
        - ``'KPFM_hartree'``: https://doi.org/10.5281/zenodo.10563098 - KPFM_hartree.tar.gz
