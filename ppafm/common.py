...
class PpafmParameters(pydantic.BaseModel):
    ...
    PBC: bool = True
    nPBC: list[int] = [1, 1, 1]
    gridN: list[int] = [-1, -1, -1]
    gridO: list[float] = [0.0, 0.0, 0.0]
    gridA: list[float] = [20.0, 0.0, 0.0]
    gridB: list[float] = [0.0, 20.0, 0.0]
    gridC: list[float] = [0.0, 0.0, 20.0]
    FFgrid0: list[float] = [-1.0, -1.0, -1.0]
    FFgridA: list[float] = [-1.0, -1.0, -1.0]
    FFgridB: list[float] = [-1.0, -1.0, -1.0]
    FFgridC: list[float] = [-1.0, -1.0, -1.0]
    moleculeShift: list[float] = [0.0, 0.0, 0.0]
    probeType: str = "O"
    charge: float = 0.00
    Apauli: float = 18.0
    Bpauli: float = 1.0
    ffModel: str = "LJ"
    Rcore: float = 0.7
    r0Probe: list[float] = [0.00, 0.00, 4.00]
    stiffness: list[float] = [-1.0, -1.0, -1.0]
    klat: float = 0.5
    krad: float = 20.00
    tip: typing.Union[str, list] = "s"
    sigma: float = 0.7
    scanStep: list[float] = [0.10, 0.10, 0.10]
    scanMin: list[float] = [0.0, 0.0, 5.0]
    scanMax: list[float] = [20.0, 20.0, 8.0]
    scanTilt: list[float] = [0.0, 0.0, -0.1]
