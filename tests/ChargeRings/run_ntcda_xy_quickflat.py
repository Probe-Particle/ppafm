...
if __name__ == "__main__":
    ...
    ap.add_argument("--W",            type=float, default=None, help="W (eV).")
    ...
    ap.add_argument("--Vstart",       type=float, default=0.8, help="Start VBias (eV).")
    ...
    ap.add_argument("--nV",           type=int, default=5, help="Number of VBias subdivisions (linspace).")
