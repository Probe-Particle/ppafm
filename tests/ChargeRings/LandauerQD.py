...
class LandauerQDs:
    def __init__(self, QDpos, Esite, K=0.01, decay=1.0, tS=0.01, E_sub=0.0, tA=0.1, eta=0.01):
        """
        ...
        Args:
            ...
            eta    : float      : Infinitesimal broadening parameter. Defaults to 0.01.
        """
        self.QDpos = QDpos
        self.K = K
        self.decay = decay
    ...
    def make_full_hamiltonian(self, tip_pos, Q_tip):
        ...
        # Fill QD block
        H[1:self.n_qds+1,1:self.n_qds+1] = H_QD_block
        
        # Fill tip coupling part
