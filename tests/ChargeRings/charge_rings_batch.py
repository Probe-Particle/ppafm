...
def main():
    ...
    for param, value in default_params.items():
        parser.add_argument(f'--{param}', type=type(value), default=value,
                          help=f'Value for {param} (default: {value})')
    
    # Add output file argument
    parser.add_argument('--output', type=str, default='charge_rings_output.png',
                       help='Output file name (default: charge_rings_output.png)')
