...
# python3 $PPPATH/photonMap.py -t s -m molecules4.ini -c cubefiles_dens.ini
...
# python $PPPATH/photonMap.py --homo output/HOMO.cube --lumo output/LUMO.cube -R 10.0 -z 5.0 -t s
python $PPPATH/photonMap.py --dens output/dens.cube -R 10.0 -z 5.0 -t s