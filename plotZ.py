...
#                    perplane.imshow(dfs[min_index+int(0.5/scan_step),:, :], origin='lower', cmap='gray')
#                    perplane.imshow(dfs[len(Zplot)-min_index-(int)(Amp/scan_step/2)-5, :, :], origin='lower', cmap='gray')
                    perplane.imshow(dfs[len(Zplot)-min_index-(int)(Amp/scan_step/2)-int(1.0/scan_step), :, :], origin='lower', cmap='gray')
