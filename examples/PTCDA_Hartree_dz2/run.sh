...
python $PPPATH/generateElFF.py -i LOCPOT.xsf -f npy #--tip dz2
python $PPPATH/generateLJFF.py -i LOCPOT.xsf -f npy 

# ======= STEP 2 : Relax Probe Particle using that force-field grid 

python $PPPATH/relaxed_scan.py -f npy  #-k 0.5 --qrange -0.20 0.20 3 --pos
#python $PPPATH/relaxed_scan.py -k 0.5 -q -0.10 --pos

# ======= STEP 3 : Plot the results

python $PPPATH/plot_results.py --df -f npy #-k 0.5 --qrange -0.20 0.20 3 --arange 0.5 2.0 2 --pos --df
