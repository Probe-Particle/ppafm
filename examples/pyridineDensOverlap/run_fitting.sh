...
python3 ../../ppafm/cli/utilities/extract_densities.py -i sample/CHGCAR.xsf --zmax 5.0

python3 ../../ppafm/cli/utilities/fitPauli.py -i sample/CHGCAR.xsf # --old


echo "======= STEP 1 : Generate force field grid."
#ppafm-conv-rho       -s sample/CHGCAR.xsf -t tip/CHGCAR.xsf -B 1.0 -E
ppafm-generate-elff  -i sample/LOCPOT.xsf -t "dz2" -f npy
