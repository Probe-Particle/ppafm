...
if(options.input == 'vasp.locpot.xsf'):
    V, lvec, nDim, head = io.loadXSF(finput)
elif(options.input == 'aims.cube'):
    V, lvec, nDim, head = io.loadCUBE(finput)
...
io.saveXSF('FFel_x.xsf', Fx, lvec, head)
io.saveXSF('FFel_y.xsf' , Fy, lvec, head)
io.saveXSF('FFel_z.xsf' , Fz, lvec, head)

io.saveVecFieldXsf( 'FFLJ', FFLJ, lvec, head)
