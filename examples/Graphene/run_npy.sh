...
python $PPPATH/generateLJFF.py -i Gr6x6N3hole.xyz  --npy 
python $PPPATH/generateElFF_point_charges.py -i Gr6x6N3hole.xyz --npy

# ======= STEP 2 : Relax Probe Particle using that force-field grid 

#python $PPPATH/relaxed_scan.py -k 0.5 --qrange -0.05 0.0 2 --pos --npy
python $PPPATH/relaxed_scan.py -k 0.5 -q -0.05 --npy
...
python $PPPATH/plot_results.py -k 0.5 -q -0.05 -a 2.0 --df --npy
